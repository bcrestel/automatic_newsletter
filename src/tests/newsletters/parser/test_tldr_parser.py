...
PATH_TO_TLDR_EMAIL = "/home/src/tests/data/email_tldr.pickle"

_parsed_email = None

def load_email():
    return load_from_pickle(PATH_TO_TLDR_EMAIL)
...
def test_check_content():
    ...
    assert entry_end['title'] == "SAM ALTMAN SAYS ARTIFICIAL GENERAL INTELLIGENCE IS ON THE HORIZON"
    #
